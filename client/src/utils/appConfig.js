...
export const WORKSPACE_NAV = {
  student: [
    ...
    { id: 'sv-schedule', label: 'Thời khóa biểu', icon: '📆', to: '/app/student/schedule' },
  ...
  finance: [
    ...
    { id: 'fi-reports', label: 'Báo cáo', icon: '📊', to: '/app/finance/reports' }
  ],
  lecturer: [
  ...
  overview: [{ id: 'ov-home', label: 'Tổng quan', icon: '🏠', to: '/app/overview' }]
};
